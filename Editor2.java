...
public class Editor2 {
	...
	public static void main (String[] args){
		...
		Color[][] input = Runigram.read(name);	
		Color[][] output = Runigram.scaled(input, width, height);
		
		Runigram.setCanvas(input);
		
		Runigram.display(input);
		
		StdDraw.pause(3000);
		
		Runigram.setCanvas(output);
		Runigram.display(output);
